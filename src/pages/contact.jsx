    ...
    >
       <div className="container lg:px-10 mx-auto flex flex-col justify-center">
        <motion.h2 
          ...
          className="text-[33px] font-bold mb-3 text-center"
        >
          Let's Work Together
        </motion.h2>
        <motion.div 
                ...
                <div className="space-y-4">
                  ...
                  >
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full dark:bg-white dark:text-black bg-black text-white py-3 px-6 rounded-md font-medium cursor-pointer hover:bg-black justify-center flex items-center gap-2"
                    >
                      <Send size={18}/>
                      Send Message
                    </motion.button>
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-neutral-600 dark:text-neutral-300">sakariyauabdulfatai2003@gmail.com</div>
                      </div>
                    </motion.div>
           ...
           dark:bg-[#131212] shadow-none  [#1a1a1a] dark:border-neutral-700 rounded-lg  overflow-hidden cursor-pointer">
                <CardContent>
                  ...
                  <p className="text-sm text-neutral-600 dark:text-neutral-300 mt-4">Follow me for updates on new projects, technical articles, and insights into web development and technical writing.</p>
                </CardContent>
              </Card>
            </motion.div>
