...
function Services() {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 py-auto md:px-5">
        {services && services.length > 0
          ? services.map((service, index) => {
           ...
           dark:bg-[#131212] shadow-none  [#1a1a1a] dark:border-neutral-700 rounded-lg transition-transform duration-300 hover:-translate-y-2 overflow-hidden cursor-pointer"
                >
      ...
      <div className="flex items-center justify-center lg:px-72 mt-12">
