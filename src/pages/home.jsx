...
function Home() {
  ...
  return ( 
   <div
      ...
      >
        <div className="container mx-auto flex flex-col justify-center text-center mt-10">
           <h3 className="text-center text-xl text-neutral-400 lg:mb-5 lg:m-6  mb-8">
            👋 Hello, I'm
          </h3>
           <h1 className="text-2xl lg:text-5xl font-bold md:mb-4 mb-2">
            SAKARIYAU ABDULFATAI
          </h1>
           <h1 className="text-2xl lg:text-[40px] font-bold mb-3">
             {displayedText}
             <span className="blinking-cursor">|</span>
           </h1>
           <div className="text-center lg:mx-48 mx-auto md:py-10 py-8 lg:px-20 px-2">
